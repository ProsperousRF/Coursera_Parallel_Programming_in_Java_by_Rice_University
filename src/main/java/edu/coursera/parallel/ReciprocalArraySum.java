...
public final class ReciprocalArraySum {
  ...
  /**
   * Modify this method to compute the same reciprocal sum as seqArraySum, but use two tasks running
   * in parallel under the Java Fork Join framework. You may assume that the length of the input
   * array is evenly divisible by 2.
   *
   * @param input Input array
   * @return The sum of the reciprocals of the array input
   */
  ...
  /**
   * Extend the work you did to implement parArraySum to use a set number of tasks to compute the
   * reciprocal array sum. You may find the above utilities getChunkStartInclusive and
  ...
  /**
   * This class stub can be filled in to implement the body of each task created to perform
   * reciprocal array sum in parallel.
   */
